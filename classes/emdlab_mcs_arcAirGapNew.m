...
classdef emdlab_mcs_arcAirGapNew < handle & emdlab_g2d_constants & matlab.mixin.SetGet
    ...
    methods
        ...
        function obj = emdlab_mcs_arcAirGapNew(center, ips, ops, Nlayer, movingBoundary)
        ...
        function updateMesh(obj)
            ...
            if alpha < obj.gaeps
                ...
                t = t(2:end-1);
                t = [cos(t),sin(t)];
                r = linspace(obj.rin, obj.rout, obj.Nlayer + 1);
                r = r(2:end-1);
                p = [obj.ips; obj.ops];
                u1 = obj.ops(1,:) - obj.ips(1,:);u1 = u1/norm(u1);
                u2 = obj.ops(end,:) - obj.ips(end,:);u2 = u2/norm(u2);
                gap = obj.rout - obj.rin;

                for i = 1:length(r)
                    p = [p; obj.ips(1,:) + u1*i*gap/obj.Nlayer ;r(i) * t + obj.center;...
                        obj.ips(end,:) + u2*i*gap/obj.Nlayer];
                end
                ...
                obj.m = emdlab_m2d_tmz(dt.ConnectivityList(c>obj.rin,:),p);
