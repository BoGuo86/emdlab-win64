% sliding contacts -> circle
% it used for full circular air-gap modeling of rotating electrical machines
% this object is used for pure mechanical rotation

classdef emdlab_scs_circle < handle & emdlab_g2d_constants & matlab.mixin.SetGet

    properties

        % inner points: boundary points of inner mesh zones
        ips (:,2) double;

        % outer points: boundary points of outer mesh zones
        ops (:,2) double;
    ...
    methods
        ...
        function obj = emdlab_scs_circle(ips, ops, Nlayer, varargin)
