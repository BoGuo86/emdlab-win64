%{
note: calculation of torque-speed curve of induction motor using parallel computing
%}
...
f_mesh = @(r) interp1([gv_Dsh/2,gv_ISD/2-gv_gap,gv_OSD/2], [2,0.5,2], r, 'linear','extrap');
...
m.aux_addCircularAirGapInterface('ag',0,0,gv_ISD/2-gv_gap,0,0,gv_ISD/2,2);
...
wmi = linspace(0,wm(end),1000);
figure;
plot(wmi*30/pi,interp1(wm,te,wmi,'spline'),'LineWidth',2);
...
te = zeros(1,300);
% run simulation for 300 time steps
for i = 1:300
