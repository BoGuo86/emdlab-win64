...
for a specific rotor position -> full model
%}
...
f_mesh = @(r) interp1([gv_Dsh/2,gv_ISD/2,gv_OSD/2], [gv_wry/2,0.4,gv_wsy/2], r, 'linear', 'extrap');
...
m.aux_addCircularAirGap('ag',0,0,gv_ISD/2-gv_gap,0,0,gv_ISD/2,3)
