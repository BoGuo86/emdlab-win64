...
f_mesh = @(r) interp1([gv_Dsh/2,gv_ISD/2,gv_OSD/2], [0.5,0.5,1], r, 'linear','extrap');
% add geometry from library
emdlab_g2d_lib_tc1(g, gv_ISD, gv_OSD, gv_Ns, gv_wst, gv_dss, gv_bs0, gv_hs0, gv_tta, 'stator', 'sc', 'sap');
emdlab_g2d_lib_rm_ipm8(g,gv_Dsh,gv_ISD-2*gv_g,gv_p,gv_embrace,gv_ra,gv_dm,0.7,0.6,0.6,'rotor','magnet','rap')
...
m.aux_addCircularAirGap('ag',0,0,gv_ISD/2-gv_g,0,0,gv_ISD/2,4)
