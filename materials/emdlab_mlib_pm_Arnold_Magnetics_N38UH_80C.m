classdef emdlab_mlib_pm_Arnold_Magnetics_N38UH_80C< handle & emdlab_mlib_permanentMagnet
    
    methods
        
        function obj = emdlab_mlib_pm_Arnold_Magnetics_N38UH_80C()
            obj.ThermalConductivity.value = 1;
            obj.HeatCapacity.value = 1;
            obj.ElectricPermitivity.value = 0;
            obj.ElectricConductivity.value = 555555.5556;        
