...
%                 obj.geom.read_g2d_bin('geom.g2d','MM');
        ...
        function obj = setWinding(obj,Directory)
            ...
            obj.win.Coils = [obj.win.Coils,circshift(obj.win.Coils,-obj.Span)];
            % set flag
            obj.isSetWin = true;
        end
