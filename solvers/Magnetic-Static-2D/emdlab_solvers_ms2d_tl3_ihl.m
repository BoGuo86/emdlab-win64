...
% two dimensional linear magnetic-static solver
...
classdef emdlab_solvers_ms2d_tl3_ihl < handle & emdlab_solvers_ms2d_tl3
    
    methods
        
        % Initialization
        function obj = emdlab_solvers_ms2d_tl3_ihl(m)
        ...
        function assignEdata(obj, InitNur)
            ...
            for i = 1:obj.m.Nmzs
                ...
                if ~obj.m.mts.(mzptr.material).MagneticPermeability.isIsotropic
                    ...
                    throw(MException('', 'Some materials are Non-Isotropic.'));
