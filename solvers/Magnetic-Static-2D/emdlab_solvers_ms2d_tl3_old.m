...
classdef emdlab_solvers_ms2d_tl3_old < handle
    ...
    methods        
        ...
        function obj = emdlab_solvers_ms2d_tl3_old()
        ...
        function evalBe(obj)
            % Evaluation of B in the center of element
            [obj.results.Bex, obj.results.Bey] = ...
                IHNLNRMSTL3_evalBe(obj.m.cl, obj.m.mtcs.gphix, ....
                obj.m.mtcs.gphiy, obj.results.A);
        ...
        function [br, bt, px, py] = getBrBtOnCircle(obj, cx, cy, r, N)
            obj.evalBn;
...
%             cb.Limits(2) = 1.7;
        ...
        function plotBrBtOnCircle(obj, varargin)
            ...
            %       b = b(index,:);
            %       b = ext_xy2rt(p,b);
            [br, bt, ~, ~] = obj.getBrBtOnCircle(varargin{:});
