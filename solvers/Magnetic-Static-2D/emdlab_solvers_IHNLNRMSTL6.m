classdef emdlab_solvers_IHNLNRMSTL6 < handle & emdlab_MSTL3

    methods

        %% Initialization
        function obj = IHNLNRMSTL6(m)
        ...
        function solve(obj)
            ...
            alpha = linspace(0.9, 1, obj.solverSettings.maxIteration);
            ...
            while (RelError > obj.solverSettings.relativeError) && (Iterations <= obj.solverSettings.maxIteration)
                ...
                obj.evalBe;
                obj.solverHistory.totalEnergy(end + 1) = obj.evalCoenergy;
