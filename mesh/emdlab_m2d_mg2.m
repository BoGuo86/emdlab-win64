function [p,t] = emdlab_m2d_mg2(fd,fh,h0,bbox,pfix,ces,varargin)

dptol=.005; ttol=.1; Fscale=1.2; deltat=0.2; geps=1e-3*h0; deps=sqrt(eps)*h0;
densityctrlfreq=30;
counter = 1;
% figure('Name','Internal Mesh Generator: MG0',...
