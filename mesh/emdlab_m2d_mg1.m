function MeshZone = emdlab_m2d_mg1(f,v, maxIteration)
...
%% Parameters
dptol=.005; ttol=.1; Fscale=1.2; deltat=0.2; geps=1e-6; deps=sqrt(eps)*h0;
densityctrlfreq=30;
counter = 1;
...
t = t.ConnectivityList(ext_dpoly2d(t.incenter,f,v)<-1e-6,:);
