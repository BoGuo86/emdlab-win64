...
classdef emdlab_g2d_db < handle
    ...
    methods
        ...
        function varargout = extentSegmentBySegment(obj, eIndex, seIndex, extAngle, extAmplitude)
        ...
        function varargout = extentSegmentByTangentArc(obj, eIndex, seIndex, extRadius, extAngle)
        ...
        function varargout = extentSegmentByArc(obj, eIndex, seIndex, xc, yc, extAngle)
            ...
            if seIndex == 0
                v2 = edgeHandle.p0.getVector;
                c = v2 + extRadius * u;
                v1 = emdlab_g2d_rotatePoints(v2, extAngle, c(1), c(2));
            else
                v1 = edgeHandle.p1.getVector;
                c = v1 + extRadius * u;
                v2 = emdlab_g2d_rotatePoints(v1, extAngle, c(1), c(2));
            end
        ...
        function varargout = extentArcByTangentSegment(obj, eIndex, seIndex, extAmplitude)
        ...
        function varargout = addLoop(obj, varargin)
            ...
            for i = 1:2:numel(varargin)
                ...
                if ischar(varargin{i})
                    loopHandle.addEdge(obj.edges(obj.getEdgeIndexByTag(varargin{i})).ptr, varargin{i+1});
                else
        ...
        function varargout = addFace(obj, faceName, varargin)
            ...
            for i = 1:numel(varargin)
                ...
                faceHandle.addLoop(obj.loops(varargin{i}));
